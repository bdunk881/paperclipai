              ...
              <div className="space-y-4 text-sm text-slate-600 dark:text-slate-300">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="rounded-2xl border border-slate-200/80 p-4 dark:border-slate-800">
                    ...
                    <p className="mt-2 text-2xl font-semibold text-slate-950 dark:text-white">{safeData.dependencyCount}</p>
                  </div>
                </div>
                <div className="flex items-center justify-between rounded-2xl border border-slate-200/80 p-4 dark:border-slate-800">
                  ...
                  <span className="font-semibold text-slate-950 dark:text-white">{safeData.activeWorkstreams}</span>
                </div>
                <div className="rounded-2xl border border-slate-200/80 p-4 dark:border-slate-800">
...
export default function MissionState() {
  ...
  const states = useMemo(() => buildStates(searchParams.get("state")), [searchParams]);
  ...
  return <MissionStateView states={states} entryPoint={entryPoint} />;
}
