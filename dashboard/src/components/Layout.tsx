...
export default function Layout() {
  ...
  if (isBuilderPopout) {
    return (
      <div className="relative flex h-screen bg-af2-paper text-af2-ink transition-colors duration-200">
        <main className="flex-1 overflow-y-auto bg-af2-paper">
          <Outlet />
        </main>
      </div>
    );
  ...
  const mobileNavToggle = (
    <button
      ...
      className="flex h-9 w-9 items-center justify-center rounded-md border border-af2-line text-af2-ink-2 transition-colors hover:bg-af2-paper-2 hover:text-af2-ink lg:hidden"
  ...
  return (
    <div className="flex h-screen flex-col bg-af2-paper text-af2-ink transition-colors duration-200">
      ...
      <div className="relative flex flex-1 overflow-hidden">
        ...
        <aside
          className={clsx(
            "fixed bottom-0 left-0 top-14 z-40 flex w-72 flex-col border-r border-af2-line bg-af2-paper text-af2-ink transition-transform lg:relative lg:top-0 lg:w-60 lg:translate-x-0",
        ...
        <main className="flex-1 overflow-y-auto bg-af2-paper transition-colors duration-200">
          <Outlet />
        </main>
      </div>
    </div>
