/**
 * MFA enrollment wizard (HEL-mfa).
 *
 * Mounted at /onboarding/mfa. Linear three-step flow:
 *   1. Choose factor — passkey (default) or TOTP authenticator app.
 *   2. Enroll the chosen factor.
 *   3. Save recovery codes (mandatory acknowledgement) → return user to
 *      `state.from` (or `/` if none).
 *
 * The wizard is reached either by the enforcement gate after a fresh
 * login (no factors) or by the user clicking "Add factor" from
 * SecuritySettings.
 */

import { useEffect, useMemo, useState } from "react";
import { useLocation, useNavigate } from "react-router-dom";
import { AlertCircle, CheckCircle2, ClipboardCopy, KeyRound, ShieldCheck, Smartphone } from "lucide-react";
import { Af2Button, Af2Card, Af2H1, Af2Page, Af2PageHead } from "../components/af2";
...
type Step = "choose" | "enroll-passkey" | "enroll-totp" | "recovery-codes" | "done";
