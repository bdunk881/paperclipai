...
async function ensureSchema(): Promise<void> {
  ...
  await queryPostgres(`ALTER TABLE agent_memory_entries ADD COLUMN IF NOT EXISTS scope text NOT NULL DEFAULT 'private'`);
  ...
  `);
  await queryPostgres(`ALTER TABLE agent_memory_kg_facts ADD COLUMN IF NOT EXISTS scope text NOT NULL DEFAULT 'private'`);
