...
export function createPkceState(userId: string, shopDomain: string): {
  state: string;
  verifier: string;
  challenge: string;
...
export function consumePkceState(state: string): { userId: string; verifier: string; shopDomain: string } | null {
