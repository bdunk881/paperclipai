...
export const PROVIDER_MODELS: Record<ProviderName, string[]> = {
  ...
  gemini: ["gemini-3.5-flash", "gemini-3.1-pro-preview", "gemini-3.1-flash-lite", "gemini-2.5-pro", "gemini-2.5-flash"],
  mistral: ["mistral-large-latest", "mistral-medium-3.5", "mistral-small-latest", "mistral-small-2603+1"],
  groq: ["openai/gpt-oss-120b", "meta-llama/llama-4-scout-17b-16e-instruct", "qwen/qwen3-32b", "groq/compound", "groq/compound-mini"],
  fireworks: [
  ...
  ollama: ["gpt-oss:20b", "gpt-oss:120b", "qwen3.6:27b", "qwen3.6:35b", "llama4:scout"],
  localai: ["gpt-oss-20b", "qwen3.6-27b", "qwen3.6-35b-a3b", "qwen_qwen3.5-35b-a3b"],
  cohere: ["command-a-plus-05-2026", "command-a-03-2025", "command-a-vision-07-2025", "command-r7b-12-2024"],
  perplexity: ["sonar-deep-research", "sonar-reasoning-pro", "sonar", "sonar-pro"],
  xai: ["grok-4.3", "grok-4.20-non-reasoning", "grok-build-0.1"],
  ...
  "vertex-ai": ["gemini-3.5-flash", "gemini-3.1-pro-preview", "gemini-3.1-flash-lite", "gemini-2.5-pro", "claude-opus-4-7"],
};
