...
- `FASTAPI_EDGE_RELAY_HOST_HEADER` and `FASTAPI_EDGE_RELAY_INSECURE_TLS` when
  the relay target requires host-header override or temporary TLS verification
  bypass during cutover
