...
locals {
  ...
  aks_egress_rules = var.restrict_internet_egress ? [
    {
    ...
    {
      name                       = "allow-azure-platform-dns-outbound"
      priority                   = 130
      direction                  = "Outbound"
      access                     = "Allow"
      protocol                   = "*"
    ...
    {
      name                       = "allow-azure-cloud-https-outbound"
      priority                   = 140
      direction                  = "Outbound"
      access                     = "Allow"
      protocol                   = "Tcp"
  ...
  pe_egress_rules = var.restrict_internet_egress ? [
    {
      name                       = "allow-vnet-outbound"
      priority                   = 120
      direction                  = "Outbound"
  ...
  svc_egress_rules = var.restrict_internet_egress ? [
    {
      name                       = "allow-vnet-outbound"
      priority                   = 120
      direction                  = "Outbound"
...
resource "azurerm_network_security_group" "aks" {
  ...
  dynamic "security_rule" {
    for_each = local.aks_egress_rules
    content {
...
resource "azurerm_network_security_group" "pe" {
  ...
  dynamic "security_rule" {
    for_each = local.pe_egress_rules
    content {
      name                       = security_rule.value.name
      priority                   = security_rule.value.priority
      direction                  = security_rule.value.direction
...
resource "azurerm_network_security_group" "svc" {
  ...
  dynamic "security_rule" {
    for_each = local.svc_egress_rules
    content {
      name                       = security_rule.value.name
      priority                   = security_rule.value.priority
      direction                  = security_rule.value.direction
