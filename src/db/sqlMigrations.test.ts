...
describe("sql migrations", () => {
  ...
  describe("migration 022 HITL activity events (HEL-16)", () => {
    const migration = readFileSync(
      path.resolve(__dirname, "..", "..", "migrations", "022_hitl_activity_events.sql"),
      "utf8"
    );
    ...
    it("declares canonical approvals and activity_events tables", () => {
      ...
      expect(migration).toContain("run_id uuid NOT NULL REFERENCES workflow_runs(id) ON DELETE CASCADE");
